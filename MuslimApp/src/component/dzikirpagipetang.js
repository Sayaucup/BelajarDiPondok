      ...
      return(
        <View style={{padding:15}}>
          <ScrollView>
            ...
            <Text style={{fontSize:20,color:'gray',marginBottom:5}}>بِسْمِ اللَّهِ الرَّحْمَنِ الرَّحِيمِ</Text>
...
class Sore extends React.Component {
  constructor(props) {
    super(props);
    this.state = { 
      data : []
  ...
  ambildata = () => {
    return fetch('https://muslimapp.000webhostapp.com/MuslimApp/dzikirsore.json')
    .then((respose) => respose.json())
    .then((resposeJson) => {
      console.log(resposeJson)
      this.setState({
      ...
      return(
        <View style={{padding:15}}>
          <ScrollView>
            ...
            <View style={{borderWidth:1,borderColor:'#ccc',marginVertical:10}}></View>
            <Text style={styles.text2}>[8] </Text>
            <Text style={styles.text1}>* {kedelapan}</Text>
            <Text style={styles.text1}>(3x)</Text>
            <View style={{borderWidth:1,borderColor:'#ccc',marginVertical:10}}></View>
            <Text style={styles.text2}>[9] </Text>
            <Text style={styles.text1}>* {kesembilan}</Text>
            ...
            <Text style={styles.text1}>* {keenambelas}</Text>
            <Text style={styles.text1}>(3x)</Text>                 
            <View style={{borderWidth:1,borderColor:'#ccc',marginVertical:5}}></View>
          </ScrollView>
        </View>
      )
